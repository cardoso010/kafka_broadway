...
config :kafka_broadway, KafkaBroadwayWeb.Endpoint,
  url: [host: "localhost"],
  render_errors: [view: KafkaBroadwayWeb.ErrorView, accepts: ~w(html json), layout: false],
  pubsub_server: KafkaBroadway.PubSub,
  live_view: [signing_salt: "kCLYP2um"]
...
config :kafka_broadway, KafkaBroadway.Mailer, adapter: Swoosh.Adapters.Local
...
config :kafka_broadway, KafkaBroadway.Application,
